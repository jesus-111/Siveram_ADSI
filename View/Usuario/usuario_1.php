...
<form action="../../Controllers/usuarioHandler.php" method="post">
    ...
    <label for="documento">Documento</label>    
        ...
        <div class="input-field ">
            <input id="Cedula" type="number" name="num_doc" min="0" value="<?php if (count($data) != 0) {echo $data[1];} ?>" readonly>
    ...
    <div class="col l4">
        ...
        <div class="input-field ">
            <input id="fecha" type="text" name="fecha" class="datepicker" value="<?php if (count($data) != 0) {echo $data[8];} ?>">
            <label for="fecha">Fecha Nacimiento</label>
        </div>
        <div class="input-field">
            <input id="rol" type="text" name="rol" value="<?php if (count($data) != 0) {echo $data[9];} ?>" readonly>
